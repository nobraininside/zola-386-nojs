---
Title: Fare un backup incrementale remoto con rsync
Published: 2022-08-28 13:51:28
Author: Writer
Layout: blog
Tag: backup,terminale,cli
...
* con un altro computer all'interno della medesima LAN di casa o dell'ufficio (mio pc -> 192.168.x.x)
* con un vostro account su un server esterno raggiungibile con un IP pubblico o un nome di dominio (mio pc -> ilmiosito.it).
